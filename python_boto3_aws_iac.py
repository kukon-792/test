...
sg_response = ec2.create_security_group(GroupName='WebTierSG', Description='Security group for the Web tier',
                                        VpcId=vpc_id)
...
sg_response = ec2.create_security_group(GroupName='AppTierSG', Description='Security group for the Application tier',
                                        VpcId=vpc_id)
app_sg_id = sg_response['GroupId']
ec2.authorize_security_group_ingress(GroupId=app_sg_id, IpPermissions=[
...
sg_response = ec2.create_security_group(GroupName='DBSG', Description='Security group for the Database tier',
                                        VpcId=vpc_id)
db_sg_id = sg_response['GroupId']
ec2.authorize_security_group_ingress(GroupId=db_sg_id, IpPermissions=[
